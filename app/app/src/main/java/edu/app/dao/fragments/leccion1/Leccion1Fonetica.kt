...
import edu.app.dao.databinding.FragmentLeccion1FoneticaBinding


class Leccion1Fonetica : Fragment() {

    private lateinit var binding: FragmentLeccion1FoneticaBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentLeccion1FoneticaBinding.inflate(inflater, container, false)
